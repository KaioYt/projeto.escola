...
function passarSlide(){
	...
	if (slideItem === 0) {
			...
			objs2[1].style.backgroundColor = "rgb(39, 124, 194)";
			objs2[2].style.backgroundColor = "rgb(39, 124, 194)";
			objs2[3].style.backgroundColor = "rgb(39, 124, 194)";

			slideItem++;

		} else if (slideItem === 1) {
			document.getElementsByClassName("slideshow_area")[0].style.marginLeft = "-"+(slidewidth * slideItem)+"px";
			objs2[0].style.backgroundColor = "rgb(39, 124, 194)";
